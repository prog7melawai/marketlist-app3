<template>
  ...
  >
    ...
    <div
      ...
      class="bounce-in"
    >
     <i class="ri-close-line close-preview"
        style="margin-top: -10px;"
        @click="closePreview">
     </i>

      <div class="search-masterbarang">
      ...
      <div style="margin-top: 60px;">
        <div style="position: relative; width: 100%;overflow-x: scroll">
          <table class="table-responsive" style="width: 110%">
            <thead class="bg-dark">
              <tr>
        ...
        <div style="width: 96%;margin: 0 auto;">
            <button class="btn-block btn-theme" style="margin-top: 15px;">
                Save
            </button>
        </div>
      </div>
  ...
  methods: {
    ...
    getFoodImage(filename) {
      if(filename === undefined){
        return `http://172.30.14.206:9882/procurement/web/masbarimages/${this.authToken}/default.png`;
      } else {
        return `http://172.30.14.206:9882/procurement/web/masbarimages/${this.authToken}/${filename}`;
      }
    },
    showingPreview(src){
      if(src === undefined){
